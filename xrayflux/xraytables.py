...
def make_SLT(outfile=None,
             ...
             plots=False):
    """
    Generate SLT (Simulated Light Travel) data.
    ...
    if rmf is not None:
        ...
        #print(rmfmatrix.shape, arf.shape)
        # interpolate aeff from its original E range to ebins
        #aeff_ebins = interp1d(specbins[:-1], aeff)(ebins[:-1])
    else : 
        # just a dummy aeff
